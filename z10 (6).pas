...
var i,n1,n2,sum: integer; //глобальные
    A,B: arry;
    
Procedure var1 (var a: arry); //заменить нулем максимальный элемент//формальные
 var i,max,n:integer;//локальные
 begin
   max:=-12345;
...
Procedure var2 (var a: arry); //умножить на 2 все элементы после минимального.//формальные // по ссылке
 var i,min,n:integer;//локальные
 begin
    min:=12345;
 ...
 Procedure var3 (a: arry); //формальные // по знач
 var i:integer;//локальные
 begin
    for i:=1 to t do sum+=A[i];               
  end; 
